...
public class ControllerManagerSample_P : MonoBehaviour
{
	...
	{
		rightCurvePointerActive = !rightCurvePointerActive;
	}

	public void ToggleRightCustomModel()
	{
		rightCustomModelActive = !rightCustomModelActive;
	}

	public void ToggleLeftLaserPointer()
	{
		leftLaserPointerActive = !leftLaserPointerActive;
	}

	public void ToggleLeftCurvePointer()
	{
		leftCurvePointerActive = !leftCurvePointerActive;
	}

	public void ToggleLeftCustomModel()
	{
		leftCustomModelActive = !leftCustomModelActive;
	}
